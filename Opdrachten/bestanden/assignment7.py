...
Maak voor deze week één logfile aan, die bij iedere opgave gebruikt wordt om
sammenvattende gegevens te registreren.
...
# Uitvoer: Een uitvoerbestand, met alle regels gecentreerd. Neem als lengte van
#          van een standaardregel 80 karakters.
#
#  log:
#          het aantal regels in het bestand en
#          de lengte van de kortste regel
#          de lengte van de langste regel
